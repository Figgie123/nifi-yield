...
@Tags({"yield","release"})
@CapabilityDescription("This processor will release flowfiles that have been yielded based on the Yield Signal.")
@SeeAlso(classNames={"org.apache.nifi.yield.Yield","org.apache.nifi.processors.standard.Wait","org.apache.nifi.processors.standard.Notify"})
